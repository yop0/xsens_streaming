...
/*! \class MetaDatagram
  Meta data (type 0x12)
  This packet contains some meta-data about the character. This is in a tagged format, each tag is formatted as
  �tagname:tagdata� and each tagline is terminated by a newline. Each value is a string that can be interpreted in its
  own way.
*/

/*! Construct a meta data datagram */
MetaDatagram::MetaDatagram() : Datagram()
{
...
/*! Return the amount of items in this datagram
  ...
  \note This does not return the same as dataCount, which returns the value stored in the header of the datagram (1
  string), but the amount of data items that are stored in the string.
*/

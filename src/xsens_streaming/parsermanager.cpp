...
Datagram * ParserManager::createDgram(StreamingProtocol proto)
{
  ...
  {
    case SPPoseEuler:
      return new EulerDatagram;
    case SPPoseQuaternion:
      return new QuaternionDatagram;
    case SPPosePositions:
      return new PositionDatagram;
    case SPMetaScaling:
      return new ScaleDatagram;
    case SPMetaMoreMeta:
      return new MetaDatagram;
    case SPJointAngles:
      return new JointAnglesDatagram;
    case SPLinearSegmentKinematics:
      return new LinearSegmentKinematicsDatagram;
    case SPAngularSegmentKinematics:
      return new AngularSegmentKinematicsDatagram;
    case SPTrackerKinematics:
      return new TrackerKinematicsDatagram;
    case SPCenterOfMass:
      return new CenterOfMassDatagram;
    case SPTimeCode:
      return new TimeCodeDatagram;
